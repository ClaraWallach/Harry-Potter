<form action="test.php" method="POST">
    ...
    <label class="pregunta"> Que objeto preferis?
        <label>
    ...
    <label class="pregunta"> Que materia preferis?
        <label>
    ...
    <label class="pregunta"> Que animal preferis?
        <label>
    ...
    <label class="pregunta"> A quien enfrentarias?
        <label>
    ...
    <label class="pregunta"> Que virtud te identifica mas?
        <label>
    ...
    <label class="pregunta"> Que color te gusta mas?
        <label>
    ...
    <label class="pregunta"> Que actividad preferis?
        <label>
    ...
    <label class="pregunta"> Elige una mascota
        <label>
    ...
    <label class="pregunta"> Que tipo de pelicula preferis?
        <label>
    ...
    <label class="pregunta"> Que transporte preferis?
        <label>
